...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @brar0315)
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @brar0315"
...
def show_id(message):
    ...
    bot_owner = "brar0315"  # 👑 The bot owner's username  ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆
    bot.send_message(message.chat.id, f"🤖 This bot is owned by: @{brar0315}")
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @brar0315)
...
This bot is owned and operated by @brar0315 on Telegram and brar_1670 on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:

* **🔒 NO WARRANTIES**: This bot is provided by "@brar0315" and "@Mk_ddos", without warranty of any kind, express or implied, including but not limited to the implied warranties of merchantability, fitness for a particular purpose, and non-infringement.
* **🚫 LIMITATION OF LIABILITY**: The owner and operator of this bot, @Mk_ddos on Telegram and brar0315 on Instagram, shall not be liable for any damages or losses arising from the use of this bot, including but not limited to direct, indirect, incidental, punitive, and consequential damages, including loss of profits, data, or business interruption.
...
* **🤝 INDEMNIFICATION**: You agree to indemnify and hold harmless @brar0315 on Telegram and brar_1670, and its affiliates, officers, agents, and employees, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from or related to your use of this bot.
* **🌐 THIRD-PARTY LINKS**: This bot may contain links to third-party websites or services, and you acknowledge that @brar0315 on Telegram and brar_1670 on Instagram is not responsible for the content, accuracy, or opinions expressed on such websites or services.
* **🔄 MODIFICATION AND DISCONTINUATION**: You agree that @brar0325 on Telegram may modify or discontinue this bot at any time, without notice, and that you will not be entitled to any compensation or reimbursement for any losses or damages arising from such modification or discontinuation.
* **👧 AGE RESTRICTION**: You acknowledge that this bot is not intended for use by minors, and that you are at least 12 years old (or the age of majority in your jurisdiction) to use this bot.
...
* **📝 ENTIRE AGREEMENT**: This disclaimer constitutes the entire agreement between you and @brar0315 on Telegram and brar_1670 on Instagram regarding your use of this bot, and supersedes all prior or contemporaneous agreements or understandings.
...
if __name__ == "__main__":
    ...
    print(" 👍 Bot is now online with @brar0315 Script and ready to Ddos_attack! ▰▱▰▱▰▱▰▱▰▱▰▱▰▱")
